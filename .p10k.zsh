# Generated by Powerlevel10k configuration wizard on 2022-10-17 at 16:28 CEST.
...
() {
  ...
  #unstage icon
  typeset -g POWERLEVEL10K_CUSTOM_UNSTAGED_ICON='\uEBCB'
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}${(g::)POWERLEVEL10K_CUSTOM_UNSTAGED_ICON}${VCS_STATUS_NUM_UNSTAGED}"
